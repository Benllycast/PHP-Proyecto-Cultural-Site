...
<a href="#">Info de Usuario</a><a href="/web/VISTA/Actividades.php">Actividades</a>
  </ul>
</div>
<!-- InstanceEndEditable -->
<!-- end header -->
<div id="wrapper">
    ...
    <!-- InstanceBeginEditable name="workArea" -->
		<div id="content">
		  <div class="post">
		    <h1 class="title">Modificar Mi Informacion Personal</h1>
		    <div class="entry">
             <p>para actualizar la informacion tenemos en nuestros registros solo tiene que ingresar los datos que desee modificar.</p>
		      <form id="form1" method="post" action="/web/VISTA/UpdateInfoUser.php">                
                       
                <table cols="2" rows="*" border="0">
                  <tr>
        			<td><span><strong>E-mail</strong></span></td>
                    <td><input name="email" type="text" class="cuadrito" onblur="YY_checkform('form1','email','S','2','Email invalido');return document.MM_returnValue" /></td>
                  </tr>
                      <tr>
                        <td><span><strong>Contrase&ntilde;a</strong></span></td>
                        <td><input name="password" type="password" class="cuadrito" id="password"  /></td>
                      </tr>
                    
                      <tr>
                        <td><span><strong>Nombres</strong></span></td>
                        <td><input name="nombre"type="text" class="cuadrito"/></td>
                      </tr>
                      <tr>
                        <td><span><strong>Apellidos</strong></span></td>
                        <td><input name="apellido" type="text"class="cuadrito" /></td>
                      </tr>
                      <tr>
                        <td><span><strong>Edad</strong></span></td>
                        <td><input name="edad" type="text"class="cuadrito" onblur="YY_checkform('form1','edad','#10_100','1','ingrese Edad \(10-100\)');return document.MM_returnValue" /></td>
                      </tr>
                      <tr>
                        <td><span><strong>Direcci&oacute;n</strong></span></td>
                        <td><input name="direccion" type="text"class="cuadrito" /></td>
                      </tr>
                      <tr>
                        <td><span><strong>Ciudad</strong></span></td>
                        <td><input name="ciudad" type="text"class="cuadrito" /></td>
                      </tr>
                      <tr>
                        <td><span><strong>Localidad - Regi&oacute;n</strong></span></td>
                        <td><input name="localidad" type="text"class="cuadrito" /></td>
                      </tr>
                      <tr>
                        <td><span><strong>Pa&iacute;s</strong></span></td>
                        <td><input name="pais" type="text"class="cuadrito" /></td>
                      </tr>
                </table>              
