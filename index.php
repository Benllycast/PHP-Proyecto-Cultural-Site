...
<div id="menu">
  <ul id="main">
    ...
    <li><a href="/web/VISTA/InfoDeUsuario.php">Info de Usuario</a></li>
	<li><a href="/web/VISTA/Actividades.php">Actividades</a></li>
	<li><?php echo $_SESSION['nikname'] ?><a href="/web/VISTA/logout.php"> &nbsp;(Salir)</a></li>
  </ul>
</div>
<!-- InstanceEndEditable -->
<!-- end header -->
